...
function displaySuccessMessage(): void
{
    if (isset($_SESSION['success_message'])) {
        echo ' <div class="alert alert-success bg-transparent text-success alert-dismissible fade show" role="alert">
...
function displayErrorMessage(): void
{
    if (isset($_SESSION['error_message'])) {
        echo ' <div class="alert alert-danger bg-transparent text-danger alert-dismissible fade show" role="alert">
